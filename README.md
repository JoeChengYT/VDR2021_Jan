...
# リポジトリ紹介
このリポジトリは2022年1月のVirtual DonkeyCar Race racingに参加するためにDonkey v4.2 の走行データ、学習済みモデル、Donkeyのコンフィグデータを共有します。
...
# 存储库介绍
该存储库共享Donkey v4.2驾驶数据、训练模型和Donkey配置数据，以参加2022年1月的Virtual DonkeyCar Race比赛。  
